...
// function ScheduleToast(scheduleData, date) {
//   const [show, setShow] = useState(false);
//   const [dateRequested, setDateRequested] = useState(null);
...
//   return (
//     <div>
//       <Button type='button' onClick={() => { AddDate(date); setShow(true); }}>
//         Schedule Date
//       </Button>
...
//         </Toast.Header>
//         <Toast.Body>
//           {dateRequested === 'success' ? <p><b>{date}</b> was added to the schedule!</p> : <p><b>{date}</b> is non-unique! Choose a different date.</p>}
//         </Toast.Body>
//       </Toast>
//     </div>
//   );
